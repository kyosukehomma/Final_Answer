...
from sqlalchemy import create_engine    # SQLAlchemyの必要なクラスや関数をインポート
...
def main():
    ...
    # データベースエンジンを作成
    engine = create_engine(f'mysql+mysqlconnector://{user}:{password}@{host}/{database}?charset={charset}')
